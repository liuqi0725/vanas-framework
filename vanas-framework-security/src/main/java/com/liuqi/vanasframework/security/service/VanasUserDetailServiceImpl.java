 ...
 */
@Log4j2
public class VanasUserDetailServiceImpl implements VanasUserDetailService {
     ...
     */
    public VanasUserDetailServiceImpl(VanasSecurityDataSourceAdapter vanasSecurityAdapter){
    ...
    @Override
    public SecurityUser loadUserByUsername(String userName, String vcid) {
        return null;
    }
}
