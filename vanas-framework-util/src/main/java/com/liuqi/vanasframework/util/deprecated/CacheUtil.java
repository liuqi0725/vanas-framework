 ...
 * @deprecated 已废弃 详见{@link com.liuqi.vanasframework.util.CacheUtil}
 */
public class CacheUtil {
     ...
     * </pre>
     */
    public synchronized void removeCacheItem(String cacheName , Object key){
...
//        CacheListData data = new CacheListData<T>(cacheName, key , var1);
